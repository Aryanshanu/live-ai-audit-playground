...
export const VIEWS = [
  ...
  { section: 'RESPONSIBLE AI', items: [
    { id: 'fairness', label: 'Fairness', icon: Scale, status: 'partial',
    ...
    { id: 'privacy', label: 'Privacy', icon: Lock, status: 'partial',
      title: 'Privacy', subtitle: 'PII detection across uploaded datasets and live model output' },
  ]},
  { section: 'SECURITY', items: [
    { id: 'jailbreak_lab', label: 'Jailbreak Lab', icon: ShieldCheck, status: 'live',
      title: 'Jailbreak Lab', subtitle: 'Live adversarial probes with a real, sample-size-disclosed containment rate' },
